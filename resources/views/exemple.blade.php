...
<body>
	...
	<header class="header navbar navbar-fixed-top" role="banner">
		...
		<div class="container">
			...
			<ul class="nav navbar-nav navbar-left hidden-xs hidden-sm">
				<li style="width: 114.8px;text-align:center;">
					<a href="#">
						<b>Parc</b>
					</a>
				</li>
	...
	<div id="container"  class="fixed-header sidebar-closed"> <!-- class="fixed-header sidebar-closed"-->
					...
					<div class="col-md-7">
						<div class="widget box">
							...
							<div class="widget-content">
								<!--<table id="ex" class="table table-striped table-bordered table-hover">
									<thead>
										<tr>
											<th>Username</th>
											<th>Email</th>
...
<script type="text/javascript" src="assets/js/libs/jquery-1.10.2.min.js"></script>
	...
	<script type="text/javascript" src="plugins/datatables/pdfmake_font.js"></script>
	...
	$(document).ready(function(){
		...
		"use strict";
		/*$('#ex').find('thead').after('<tbody><tr><td>Joey</td><td>Greyson</td><td class="hidden-xs">joey123</td><td><span class="label label-success">Approved</span></td></tr><tr><td>Joey</td><td>Greyson</td><td class="hidden-xs">joey123</td><td><span class="label label-success">Approved</span></td></tr><tr><td>Joey</td><td>Greyson</td><td class="hidden-xs">joey123</td><td><span class="label label-success">Approved</span></td></tr><tr><td>Joey</td><td>Greyson</td><td class="hidden-xs">joey123</td><td><span class="label label-success">Approved</span></td></tr><tr><td>Joey</td><td>Greyson</td><td class="hidden-xs">joey123</td><td><span class="label label-success">Approved</span></td></tr><tr><td>Joey</td><td>Greyson</td><td class="hidden-xs">joey123</td><td><span class="label label-success">Approved</span></td></tr><tr><td>Joey</td><td>Greyson</td><td class="hidden-xs">joey123</td><td><span class="label label-success">Approved</span></td></tr><tr><td>Joey</td><td>Greyson</td><td class="hidden-xs">joey123</td><td><span class="label label-success">Approved</span></td></tr><tr><td>Wolf</td><td>Bud</td><td class="hidden-xs">wolfy</td><td><span class="label label-info">Pending</span></td></tr><tr><td>Darin</td><td>Alec</td><td class="hidden-xs">alec82</td><td><span class="label label-warning">Suspended</span></td></tr></tbody>');*/
		...
		$('.dataTables_header > div:first').removeClass('col-md-6').addClass('col-md-3');
		$('.dataTables_header > div:nth-child(2)').removeClass('col-md-6').addClass('col-md-9');

		$('#ex_filter').before('<div class="DTTT btn-group">'+
			'<a class="btn DTTT_button_print"><span>Print</span></a>'+
			'<a class="btn DTTT_button_csv"><span>CSV</span></a>'+
			'<a class="btn DTTT_button_xls"><span>Excel</span></a>'+
			'<a class="btn DTTT_button_pdf"><span>PDF</span></a></div>');
	});
	</script>
