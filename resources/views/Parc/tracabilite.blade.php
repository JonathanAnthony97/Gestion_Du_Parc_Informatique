					...
					<div class="col-md-11 col-md-offset-1" style="margin-top: 0px;">
						<div class="widget">
							...
							<div class="widget-content" style="margin-top: 0px;">
								...
								<a href="{{ route('suivi') }}" class="list-group-item active">
					...
					<div class="col-md-12">
						<div class="widget box animated fadeInDown" >
							<div class="widget-header">
								<h4 id="titre"><i class="icon-hdd"></i> <span>Tracabilite</span></h4>
										...
										<div class="dataTables_wrapper form-inline" role="grid">
											<div class="row">
												<div class="dataTables_header clearfix">
													<div class="col-md-4">
														<div class="dataTables_length"><label><select id="const7" size="1" aria-controls="DataTables_Table_3" class="select2-offscreen" tabindex="-1"><option id="init" value="5">5</option><option value="10">10</option><option value="25">25</option><option value="50">All</option></select> par page</label></div>
													</div>

													<div class="col-md-8">
														<div class="DTTT btn-group">
												
														<a id="TracabilitExcel" href="#" class="btn DTTT_button_xls"><span>Excel</span></a>
														
														</div>
														
														<div class="dataTables_filter" id="filter"><label><div class="input-group"><span class="input-group-addon"><i class="icon-search"></i></span><input type="text" name="search_trace" id="data_search" class="form-control"></div></label>
														</div>
														
														<div style="width: 165px;margin-right: 10px" class="DTTT btn-group">
															<select id="traceType" name="Type" class="select2 col-md-12 full-width-fix">
															<option value="0"> Selectionner type </option>
																@foreach($types as $tp)
																<option value="{{ $tp->id_catg }}">{{ $tp->categorie }}</option>
																@endforeach
															</select>
														</div>
												
													</div>
													<div id="processeur6" class="dataTables_processing" style="visibility: hidden;">Processing...</div>
												</div>
											</div>
											<div id="ajax_trace" style="padding-top: 5px;">
													@include('Parc.list')
											</div>
										</div>
									</div>
