...
@section('content')
		<div id="content" >
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="widget box anime fadeIn" >
								...
								<div class="dataTables_wrapper form-inline" role="grid">
									<div class="row">
										...
										<div class="col-md-10">
											...
											<div class="DTTT btn-group">
												<a href="#" class="btn DTTT_button change_etat"><span><i class="icon-refresh"></i> Etat</span></a>
											</div>
			...
			<div class="modal-dialog" style="width: 97%;margin-top: 0px;">
				<div class="modal-content" style="background-color: #f9f9f9;">
					...
					<div class="row">
													...
													<div class="tab-content" style="overflow:hidden;background:#f9f9f9;">
														<div class="tab-pane" id="tabe_f1">
															<form class="form-vertical" id="Faire_Affectation" method="post" action="{{ route('affectation') }}">
																...
																<button style="margin-right: 28px;margin-top: 13px;margin-bottom: 10px;" class="btn btn-sm  pull-right" type="submit"><i class="icon-check"></i> Sauver</button>
															</form>
														</div>
						...
						<div class="col-md-8" style="margin-top: 6px;padding-left: 8px;">
														...
														<div class="dataTables_header clearfix">
															...
															<div class="col-md-9">
																<div class="DTTT btn-group pull-right">
																	<a id="TracExcel" href="#" class="btn DTTT_button_xls"><span>Excel</span></a>
																</div>
															</div>
														</div>
													...
													<div class="dataTables_wrapper form-inline" role="grid">
														<div class="dataTables_header clearfix">
															...
															<div class="col-md-12">
																...
																<div class="DTTT btn-group pull-right">
																	<a id="MaintExcel" href="#" class="btn DTTT_button_xls"><span>Excel</span></a>
																</div>
															</div>
														</div>
													...
													<div class="dataTables_wrapper form-inline" role="grid">
														<div class="dataTables_header clearfix">
															...
															<div class="col-md-12">
																...
																<div class="DTTT btn-group pull-right">
																	<a id="ReparExcel" href="#" class="btn DTTT_button_xls"><span>Excel</span></a>	
																</div>
															</div>
														</div>
													...
													<div class="dataTables_wrapper form-inline" role="grid">
														<div class="dataTables_header clearfix">
															...
															<div class="col-md-12">
																...
																<div class="DTTT btn-group pull-right">
																	<a id="PanExcel" href="#" class="btn DTTT_button_xls"><span>Excel</span></a>	
																</div>
															</div>
														</div>
