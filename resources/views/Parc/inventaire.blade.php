						...
						<div class="widget">
							...
							<div class="widget-content" style="margin-top: 0px;">
      						...
      						<div class="list-group">
      							...
      							<a  href="{{ route('invent') }}" class="list-group-item active"><img src="{{ asset('assets/image/inve.png') }}">  <b>Inventaire</b></a>
			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<a href="{{ route('suivi') }}">Inventaire</a>
						</li>
					...
					<div class="col-md-12">
						<div class="widget box animated fadeInDown" >
							<div class="widget-header">
								<h4 id="titre"><i class="icon-hdd"></i> <span>Inventaire</span></h4>
										...
										<div class="dataTables_wrapper form-inline" role="grid">
											<div class="row">
												<div class="dataTables_header clearfix">
													<div class="col-md-4">
														<div class="dataTables_length"><label><select id="const13" size="1" aria-controls="DataTables_Table_3" class="select2-offscreen" tabindex="-1"><option id="init" value="5">5</option><option value="10">10</option><option value="25">25</option><option value="50">All</option></select> par page</label></div>
													</div>

													<div class="col-md-8">
														<div class="DTTT btn-group">
												
														<a href="{{ URL::to('inventairExcel/xlsx') }}" class="btn DTTT_button_xls"><span>Excel</span></a>
														</div>
														
														<div class="dataTables_filter" id="filter"><label><div class="input-group"><span class="input-group-addon"><i class="icon-search"></i></span><input type="text" name="search_invent" id="data_search" class="form-control"></div></label>
														</div>
														
													</div>
													<div id="processeur15" class="dataTables_processing" style="visibility: hidden;">Processing...</div>
												</div>
											</div>
											<div id="ajax_invent" style="padding-top: 5px;">
													@include('Parc.listInvent')
											</div>
										</div>
									</div>
								</div>
