						...
						<div class="widget">
							...
							<div class="widget-content" style="margin-top: 0px;">
      						...
      						<div class="list-group">
      							...
      							<a class="list-group-item g_m2 active" data-toggle="collapse" data-target="#sample3"><img src="{{ asset('assets/image/histo.png') }}"> <b>Historiques</b> <i style="float: right;padding-top: 2px;" class="arrow icon-angle-left"></i></a>
			...
			<div class="container">
				...
				<div class="crumbs">
					<ul id="breadcrumbs" class="breadcrumb">
						...
						<li class="current">
							<a href="{{ route('histo') }}" title="">Historiques</a>
						</li>
					</ul>
					...
					<div class="col-md-12">
						<div class="widget box animated fadeInDown" >
							<div class="widget-header">
								<h4 id="titre"><i class="icon-hdd"></i> <span>Historiques</span></h4>
								...
								<div class="dataTables_wrapper form-inline" role="grid">
									<div class="row">
										<div class="dataTables_header clearfix">
											<div class="col-md-2">
												<div class="dataTables_length"><label><select id="const6" size="1" aria-controls="DataTables_Table_3" class="select2-offscreen" tabindex="-1"><option id="init" value="5">5</option><option value="10">10</option><option value="25">25</option><option value="50">All</option></select> par page</label></div>
										...
										<div class="col-md-10">
											<div class="DTTT btn-group">
												...
												<a id="InterventionExcel" href="#" class="btn DTTT_button_xls"><span>Excel</span></a>
										
											</div>

											<div class="dataTables_filter" id="filter"><label><div class="input-group"><span class="input-group-addon"><i class="icon-search"></i></span><input type="text" name="search_histo" id="data_search" class="form-control"></div></label></div>
											
											<div class="DTTT btn-group" style="margin-right: 10px;">
												<a href="#" class="btn DTTT_button supr"><span><i class="icon-trash"></i> Supprimer</span></a>
											</div>
											<div style="width: 170px;" class="DTTT btn-group">
												<b><select id="interType" name="Type" class="select2 col-md-12 full-width-fix">
													<option value="0"> Type Intervention</b></option>
										...
										<div id="processeur5" class="dataTables_processing" style="visibility: hidden;">Processing...</div>
									</div>
								</div>

								<div id="ajax_histo" style="padding-top: 0px;">
								@include('Parc.histo')
								</div>
							</div>
							</div>
