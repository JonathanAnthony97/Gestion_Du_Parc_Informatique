...
<head>
	...
	<title>Static Tables | Melon - Flat &amp; Responsive Admin Template</title>
	...
	<link href="assets/css/fichier_css.css" rel="stylesheet" type="text/css">
...
<body>
				...
				<div class="row" style="margin-top: 12px;">
						...
						<div class="widget">
							...
							<div class="widget-content">
        						...
        						<a id="first" href="#" class="list-group-item active" data-toggle="collapse" data-target="#sample1">
    								<i id="i" class="icon-folder-open"></i>  Cras justo odio <i style="float: right;padding-top: 2px;" class="arrow icon-angle-left"></i>
  								</a>
  									<div class="collapse" style="overflow-y: hidden;" id="sample1">
  										<div class="card card-body">

    										<a href="#" style="border-bottom: 0px;" class="list-group-item"><span style="padding-left: 15px;"><i id="i" class="icon-folder-open"></i>  Dapibus ac facilisis</span></a>
						        			<a href="#" style="border-bottom: 0px;border-top:0px;" class="list-group-item"><span style="padding-left: 15px;"><i id="i" class="icon-folder-open"></i>  Morbi leo risus</span></a>
						        			<a href="#" style="border-bottom: 0px;border-top:0px;" class="list-group-item"><span style="padding-left: 15px;"><i id="i" class="icon-folder-open"></i>  Morbi leo risus</span></a>
						        ...
						        <a id="last" href="#" class="list-group-item">Vestibulum at eros</a>
      						</div>
      						<div class="list-group">
        						<a href="#" class="list-group-item active" data-toggle="collapse" data-target="#sample1">
    								<i class="icon-folder-open"></i>  Cras justo odio <i style="float: right;padding-top: 2px;" class="arrow icon-angle-left"></i>
  								</a>
  									<div class="collapse" id="sample1">
  										<div class="card card-body">

    										<a href="#" style="border-bottom: 0px;" class="list-group-item"><span style="padding-left: 15px;"><i class="icon-folder-open"></i>  Dapibus ac facilisis</span></a>
						        			<a href="#" style="border-bottom: 0px;border-top:0px;" class="list-group-item"><span style="padding-left: 15px;"><i class="icon-folder-open"></i>  Morbi leo risus</span></a>
						...
						<div class="widget box">
							...
							<div class="widget-content"><!--  no-padding-->
								<div class="dataTables_wrapper form-inline" role="grid">
									<div class="row">
										<div class="dataTables_header clearfix"><div class="col-md-4">
										...
										<div class="col-md-8">
											<div class="DTTT btn-group">
												<a href="{{ URL::to('downloadExcel/csv') }}" class="btn DTTT_button_csv"><span>CSV</span></a>
											...
											<div class="dataTables_filter" id="filter"><label><div class="input-group"><span class="input-group-addon"><i class="icon-search"></i></span><input type="text" name="search" class="form-control"></div></label></div>
										</div>
										<div id="processeur" class="dataTables_processing" style="visibility: hidden;">Processing...</div>
									</div>
								</div>
								<div id="ajax" style="margin-top: 8px;">
								@include('test')
								</div>
							</div>
	...
	/*$(document).ready(function(){
		...
		"use strict";
		$('option[value="'+ {{ Session::get('Par_page') }} +'"]').attr('selected',true);
		App.init(); // Init layout and core plugins
		Plugins.init(); // Init all plugins
		FormComponents.init(); // Init all form-specific plugins

		//navigateur
            function getData(page,arg){
             //$('#im').css('visibility','');
             if(arg == undefined){
             	var cible='pagination/ajax?page='+page;
             }else{
             	var cible='pagination/ajax?page='+page+'&cle='+arg;
             }
